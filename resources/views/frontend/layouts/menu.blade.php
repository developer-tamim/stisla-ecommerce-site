                   ...
                   <div class="relative_contect d-flex">
                       ...
                       <ul class="wsus_menu_cat_item show_home toggle_menu">
                           ...
                           @foreach ($categories as $category)
                               <li><a class="{{ count($category->subCategorires) > 0 ? 'wsus__droap_arrow' : '' }}"
                                       href="#"><i class="{{ $category->icon }}"></i> {{ $category->name }} </a>

                                   @if (count($category->subCategorires) > 0)
                                       <ul class="wsus_menu_cat_droapdown">
                                           @foreach ($category->subCategorires as $subCategory)
                   ...
                   <div class="accordion accordion-flush" id="accordionFlushExample">
                       <ul class="wsus_mobile_menu_category">
                           ...
                           @foreach ($categories as $categoryItem)
                               <li><a href="#" class="{{count($categoryItem->subCategorires) > 0 ? 'accordion-button' : ''}} collapsed" data-bs-toggle="collapse"
                                   ...
                                   @if (count($categoryItem->subCategorires) > 0)
                                       <div id="flush-collapseThreew-{{ $loop->index }}"
                                           ...
                                           <div class="accordion-body">
                                               <ul>
                                                   ...
                                                   @foreach ($categoryItem->subCategorires as $subCategoryItem)
