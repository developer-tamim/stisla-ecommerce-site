    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($query) {
                $editBtn = "<a href='" . route('admin.child-category.edit', $query->id) . "' class='btn btn-primary d-inline'><i class='fa-solid fa-pen-to-square'></i></a>";
                $deleteBtn = "<a href='" . route('admin.child-category.destroy', $query->id) . "' class='btn btn-danger d-inline ml-2 delete-item'><i class='fa-regular fa-trash-can'></i></a>";
